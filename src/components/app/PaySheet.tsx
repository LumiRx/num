...
export default function PaySheet() {
  ...
  return (
    <div ref={ref} className="glass-strong sheet-in" style={{ ...sheetBase, visibility: 'visible', transform: 'translateY(0)', maxHeight: 'min(86%, calc(100% - var(--sat, 0px) - 8px))', overflowY: 'auto' }}>
