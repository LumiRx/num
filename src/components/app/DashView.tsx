...
import type { Booking, Connections } from '../../lib/types';
...
function ConnectionsCard() {
  ...
  return (
    <div className="glass" style={card}>
      <div style={kicker}>CONNECT YOUR WORLD</div>
      <div style={{ fontSize: 11.5, color: 'var(--ink-60)', marginTop: 5, lineHeight: 1.5 }}>
        All off until you say so. Num asks for each one at the moment it needs it, and never reads more than the job takes.
      </div>
    ...
    <div className="no-scrollbar" style={{ flex: 1, overflowY: 'auto', paddingBottom: 96 }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ fontSize: 11, color: 'var(--ink-60)', marginTop: 2 }}>
            {events.length
              ? `${events[0].yes ?? 0} of ${events[0].invited ?? 0} coming · RSVP by text`
