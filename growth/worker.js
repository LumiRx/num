...
async function sendClaimWelcome(env, c) {
  ...
  const text = th
    ...
    : [
        ...
        "gave us. Once it is checked we will email you a link to your NUM",
        "dashboard — that is where you manage your listing and what",
        "travellers see. No password: the link signs you straight in.",
        "",
