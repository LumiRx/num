...
_Built 2026-09-19 20:35 UTC from 45 entries._
...
| num-accounts | 🔴 **STALE** — 1 file changed since it shipped |
...
- 🟡 **qr bill pay** — Payout visibility - the cheapest large win on the venue side, and it turned out to be two numbers rather than one. Under direct charges the money goes to the VENUE's own Stripe balance on the VENUE's own schedule, which is the design and is not changing. What it cost was visibility: a venue watched NUM bills settle with nowhere in the product saying when the money arrives. 'Where is it' is the first question a new venue asks and had no answer. The honest shape is two figures side by side that ar
  _claude, 2026-09-19 20:35_
